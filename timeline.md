...
📌 점심 미팅에서 꼭 확인할 7가지
Amazon 크롤러를 바로 사용할 수 있는가?
개발 경험이 있는 사람은 누구이며 어떤 경험이 있는가?
AI는 어떤 API를 사용할 것인가?
데이터 컬럼과 JSON 구조를 먼저 통일할 것인가?
역할은 기능 단위로 나눌 것인가?
초보자도 실제 코드를 맡을 수 있도록 역할을 배분할 것인가?
1주일 안에 완성하기 위해 반드시 구현할 기능과 제외할 기능은 무엇인가?
